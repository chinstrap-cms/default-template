...
A big part of the philosophy behined Chinstrap is that as far as possible, it uses off-the-shelf PHP libraries that you may already be familiar with. This has the following advantages:
...
* **Requests** - `laminas/laminas-diactoros`
* **Forms** - `laminas/laminas-form`
